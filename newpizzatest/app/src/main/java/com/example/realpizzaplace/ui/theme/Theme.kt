package com.example.realpizzaplace.ui.theme
...
private val LightColorPalette = RealPizzaPlaceColors(
    brand = Shadow5,
...
private val DarkColorPalette = RealPizzaPlaceColors(
    brand = Shadow1,
...
@Composable
fun RealPizzaPlaceTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    content: @Composable () -> Unit
) {
    val colors = if (darkTheme) DarkColorPalette else LightColorPalette

    ProvideRealPizzaPlaceColors(colors) {
        MaterialTheme(
...
object RealPizzaPlaceTheme {
    val colors: RealPizzaPlaceColors
        @Composable
        get() = LocalRealPizzaPlaceColors.current
}

/**
 * RealPizzaPlace custom Color Palette
 */
@Stable
class RealPizzaPlaceColors(
    ...
    fun update(other: RealPizzaPlaceColors) {
    ...
    fun copy(): RealPizzaPlaceColors = RealPizzaPlaceColors(
...
@Composable
fun ProvideRealPizzaPlaceColors(
    colors: RealPizzaPlaceColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalRealPizzaPlaceColors provides colorPalette, content = content)
}

private val LocalRealPizzaPlaceColors = staticCompositionLocalOf<RealPizzaPlaceColors> {
    error("No RealPizzaPlaceColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [RealPizzaPlaceTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
