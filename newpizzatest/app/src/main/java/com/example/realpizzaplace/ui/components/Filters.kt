...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) RealPizzaPlaceTheme.colors.brandSecondary else RealPizzaPlaceTheme.colors.uiBackground,
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else RealPizzaPlaceTheme.colors.textSecondary,
        label = "text color"
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    RealPizzaPlaceTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
